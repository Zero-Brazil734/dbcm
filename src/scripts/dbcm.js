...
class CmdManager {
    ...
    async runCommand(command, msg, args, hdo = {}) {
        ...
        if (this.settings.runCommand !== undefined && this.settings.runCommand.cooldown !== undefined && this.settings.runCommand.cooldown.time !== undefined && typeof this.settings.runCommand.cooldown.time !== "number" && this.settings.runCommand.cooldown.time >= 0 && this.settings.runCommand.cooldown.time < 3000) throw new RangeError(chalk.default.magenta(this.lang.minimumis3))
        if (this.settings.runCommand !== undefined && this.settings.runCommand.cooldown !== undefined && this.settings.runCommand.cooldown.time !== undefined && typeof this.settings.runCommand.cooldown.time !== "number" && this.settings.runCommand.cooldown.time > 60000 * 5) throw new RangeError(chalk.default.magenta(this.lang.maximumis5))
        ...
        if (this.settings.runCommand !== undefined && this.settings.runCommand.cooldown !== undefined && this.settings.runCommand.cooldown.msg !== undefined) {
            var cooldownMsg = this.settings.runCommand.cooldown.msg,
                cdresult = cooldownMsg.replace("%{message.author}", msg.author).replace("%{message.author.id}", msg.author.id).replace("%{message.guild.id}", msg.guild.id).replace("%{message.guild.name}", msg.guild.name).replace("%{cmd.cooldown}", (this.settings.runCommand.cooldown.time / 1000))
        }
